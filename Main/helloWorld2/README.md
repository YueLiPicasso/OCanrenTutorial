...
over self, and then instantiation by self with an additional equation to close the loop. Next we show how this insight
 helps with typing relational programs.
