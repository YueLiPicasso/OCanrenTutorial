...
care of the precedence, associativity and/or scope of the logic connectives.
- [**T.10**](#t10-ocanren-terms) Observing that the implementation of the `ocanren {}` quotation replaces  value constructors
