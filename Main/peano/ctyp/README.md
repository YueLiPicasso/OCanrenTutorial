...
together with the command `make > tt` (followded by some minor editing such as renaming the file,
deleting some not needed output and adding extra spaces). We could see in the interface that
